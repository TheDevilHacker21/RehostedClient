package net.runelite.client.inactiveplugins.hd.scene.model_overrides;
...
import net.runelite.client.inactiveplugins.hd.data.NpcID;
import net.runelite.client.inactiveplugins.hd.data.ObjectID;
