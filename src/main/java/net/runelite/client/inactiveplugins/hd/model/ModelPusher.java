package net.runelite.client.inactiveplugins.hd.model;
...
import net.runelite.client.inactiveplugins.hd.data.materials.Overlay;
import net.runelite.client.inactiveplugins.hd.data.materials.Underlay;
import net.runelite.client.inactiveplugins.hd.data.materials.UvType;
import net.runelite.client.inactiveplugins.hd.scene.SceneUploader;
import net.runelite.client.inactiveplugins.hd.scene.model_overrides.InheritTileColorType;
...
import net.runelite.client.inactiveplugins.hd.scene.model_overrides.TzHaarRecolorType;
import net.runelite.client.inactiveplugins.hd.utils.HDUtils;
import net.runelite.client.inactiveplugins.hd.utils.ModelHash;
import net.runelite.client.inactiveplugins.hd.utils.PopupUtils;
import net.runelite.client.util.LinkBrowser;
import net.runelite.client.inactiveplugins.hd.HdPlugin;
import net.runelite.client.inactiveplugins.hd.HdPluginConfig;
import net.runelite.client.inactiveplugins.hd.scene.ProceduralGenerator;
import net.runelite.client.inactiveplugins.hd.scene.SceneContext;
...
//		return sceneContext.modelFaceNormals;
    ...
    private boolean isBakedGroundShading(int face, int heightA, int heightB, int heightC, int[] faceTransparencies, short[] faceTextures) {
        return
...
//            return INT_ZEROS;
        ...
        if (modelOverride.flatNormals) {
            ...
            int lightenA = (int) (Math.max((color1L - IGNORE_LOW_LIGHTNESS), 0) * LIGHTNESS_MULTIPLIER) + BASE_LIGHTEN;
            float dotA = Math.max(0, HDUtils.dotLightDirectionModel(
                    xVertexNormals[triA],
                    yVertexNormals[triA],
                    zVertexNormals[triA]
            ));
            ...
            int lightenB = (int) (Math.max((color2L - IGNORE_LOW_LIGHTNESS), 0) * LIGHTNESS_MULTIPLIER) + BASE_LIGHTEN;
            float dotB = Math.max(0, HDUtils.dotLightDirectionModel(
                    xVertexNormals[triB],
                    yVertexNormals[triB],
                    zVertexNormals[triB]
            ));
            ...
            int lightenC = (int) (Math.max((color3L - IGNORE_LOW_LIGHTNESS), 0) * LIGHTNESS_MULTIPLIER) + BASE_LIGHTEN;
            float dotC = Math.max(0, HDUtils.dotLightDirectionModel(
                    xVertexNormals[triC],
                    yVertexNormals[triC],
                    zVertexNormals[triC]
            ));
