...
public final class Tile extends Node implements RSTile {
    ...
    public final InteractableObject[] gameObjects;
    ...
    public Tile(int i, int j, int k) {
        gameObjects = new InteractableObject[5];
    ...
    public boolean hasLineOfSightTo(net.runelite.api.Tile other) {
        ...
        CollisionData[] collisionData = online.paescape.Client.instance.getCollisionMaps();
    ...
    public List<net.runelite.api.Tile> pathTo(net.runelite.api.Tile other) {
        ...
        Tile[][][] tiles = (Tile[][][]) online.paescape.Client.instance.getScene().getTiles();
    ...
    public WorldPoint getWorldLocation() {
        return WorldPoint.fromScene(online.paescape.Client.instance, getX(), getY(), getPlane());
    }
...
//        this.wallCullDirection = wallCullDirection;
    ...
    public void gameObjectsChanged(int idx) {
        if (idx != -1) {
            ...
            Logger logger = online.paescape.Client.instance.getLogger();
            if (current == null) {
                if (prevInvalid) {
                    return;
                }
                ...
                online.paescape.Client.instance.getCallbacks().post(gameObjectDespawned);
                ...
                online.paescape.Client.instance.getCallbacks().post(gameObjectSpawned);
            }
        }
    }
    ...
    public void wallObjectChanged() {
        ...
        if (current == null && previous != null) {
            ...
            online.paescape.Client.instance.getCallbacks().post(wallObjectDespawned);
            ...
            online.paescape.Client.instance.getCallbacks().post(wallObjectSpawned);
        }
    }
    ...
    public void decorativeObjectChanged() {
        ...
        if (current == null && previous != null) {
            ...
            online.paescape.Client.instance.getCallbacks().post(decorativeObjectDespawned);
        } else if (current != null && previous == null) {
            ...
            online.paescape.Client.instance.getCallbacks().post(decorativeObjectSpawned);
            ...
            online.paescape.Client.instance.getCallbacks().post(decorativeObjectChanged);
        }
    }
    ...
    public void groundObjectChanged() {
        ...
        if (current == null && previous != null) {
            ...
            online.paescape.Client.instance.getCallbacks().post(groundObjectDespawned);
        } else if (current != null && previous == null) {
            ...
            online.paescape.Client.instance.getCallbacks().post(groundObjectSpawned);
        }
    }
    ...
    public void itemLayerChanged(int idx)
    {
        int x = getX();
        int y = getY();
        int z = online.paescape.Client.instance.getPlane();
        RSNodeDeque[][][] groundItemDeque = online.paescape.Client.instance.getGroundItemDeque();

        RSNodeDeque oldQueue = lastGroundItems[z][x][y];
        RSNodeDeque newQueue = groundItemDeque[z][x][y];

        if (online.paescape.Client.instance.getGameState() != GameState.LOGGED_IN)
        {
            lastGroundItems[z][x][y] = newQueue;
            online.paescape.Client.instance.setLastItemDespawn(null);
            return;
        }
        ...
        if (oldQueue != newQueue)
        {
            if (oldQueue != null)
            {
                ...
                for (RSNode cur = head.getNext(); cur != head; cur = cur.getNext())
                {
                    ...
                    online.paescape.Client.instance.getCallbacks().post(itemDespawned);
                }
            }
            lastGroundItems[z][x][y] = newQueue;
        }

        RSTileItem lastUnlink = online.paescape.Client.instance.getLastItemDespawn();
        if (lastUnlink != null)
        {
            online.paescape.Client.instance.setLastItemDespawn(null);
        }
        ...
        if (current != null)
        {
            ...
            online.paescape.Client.instance.getCallbacks().post(event);
        }
    }
