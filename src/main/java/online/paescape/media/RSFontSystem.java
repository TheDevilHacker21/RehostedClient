...
public class RSFontSystem extends DrawingArea {
    ...
    public static String handleOldSyntax(String text) {
        ...
        text = replace(text, "@red@", "<col=ad0919>");
        text = replace(text, "@gre@", "<col=549e09>");
        text = replace(text, "@blu@", "<col=120aa6>");
        text = replace(text, "@yel@", "<col=b0b320>");
        ...
        text = replace(text, "@gr1@", "<col=549e09>");
                    ...
                    if (effectString.equals(startEffect)) {
                        ...
                        if (effectString.startsWith(startImage)) {
                            try {
                                ...
                                int imageId = EmojiHandler.checkEmoji(effectString.substring(4));
                                Sprite icon = SpriteLoader.sprites[679 + imageId];
